            ...
            <table class="tg">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="tg-row1-attr"><a href="/edit_post/110"><button class="tg-btn-row">Edit</button></a> </td>
                        <td class="tg-row1-attr"><a href="/del_post/110"><button class="tg-btn-row">Del</button></a> </td>
                    </tr>
                    <tr>
                        ...
                        <td class="tg-row1-attr"><a href="/edit_post/120"><button class="tg-btn-row">Edit</button></a> </td>
                        <td class="tg-row1-attr"><a href="/del_post/120"><button class="tg-btn-row">Del</button></a> </td>
                    </tr>
                    <tr>
                        <td class="tg-row1-attr">2023/08/28</td>
                        ...
                        <td class="tg-row1-attr">3</td>
                        <td class="tg-row1-attr">2</td>
                        <td class="tg-row1-attr"><a href="/edit_post/130"><button class="tg-btn-row">Edit</button></a> </td>
                        <td class="tg-row1-attr"><a href="/del_post/130"><button class="tg-btn-row">Del</button></a> </td>
                    </tr>
                    <tr>
                        <td class="tg-row2-attr">2023/08/28</td>
                        ...
                        <td class="tg-row2-attr">10</td>
                        <td class="tg-row2-attr">3</td>
                        <td class="tg-row1-attr"><a href="/edit_post/140"><button class="tg-btn-row">Edit</button></a> </td>
                        <td class="tg-row1-attr"><a href="/del_post/140"><button class="tg-btn-row">Del</button></a> </td>
                    </tr>
                    <tr>
                        <td class="tg-row1-attr">2023/08/28</td>
                        ...
                        <td class="tg-row1-attr">3</td>
                        <td class="tg-row1-attr">2</td>
                        <td class="tg-row1-attr"><a href="/edit_post/150"><button class="tg-btn-row">Edit</button></a> </td>
                        <td class="tg-row1-attr"><a href="/del_post/150"><button class="tg-btn-row">Del</button></a> </td>
                    </tr>
                    <tr>
                        <td class="tg-row2-attr">2023/08/28</td>
                        ...
                        <td class="tg-row2-attr">10</td>
                        <td class="tg-row2-attr">3</td>
                        <td class="tg-row1-attr"><a href="/edit_post/160"><button class="tg-btn-row">Edit</button></a> </td>
                        <td class="tg-row1-attr"><a href="/del_post/160"><button class="tg-btn-row">Del</button></a> </td>
                    </tr>
                </tbody>
            </table>
        </div>
